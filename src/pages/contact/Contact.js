    ...
    <div class="row ola">
        <div class="col-sm-1 col-1">
          <div class="card1 d-flexl- justify-content-center">
            ...
            <div class="info11">
              <div>
                <p><ion-icon name="location-sharp"></ion-icon> Ahmedabad</p>
              </div>
  
              <div>
                <p><ion-icon name="mail"></ion-icon> safar@info.com</p>
              </div>
  
              <div>
                <p><ion-icon name="call"></ion-icon> +91-1234567890</p>
              </div>
            </div>
          ...
          <div class="card2 d-flex justify-content-center">
            ...
            <div class="form55">
              <form>
                ...
                <div>
                  <label for="lname">Write something here...</label><br />
                  <textarea
                    name=""
                    id=""
                    cols="55"
